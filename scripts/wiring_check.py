...
STANDALONE = {
    ...
    # Historical only. Project-original synthesis is now an explicitly unshippable fallback;
    # source_music.py obtains real, named-artist recordings for every daily run.
    "score.py": "historical generator for an explicitly disabled and unshippable old score",
}
