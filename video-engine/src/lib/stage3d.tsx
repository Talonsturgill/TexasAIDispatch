...
// =============================================================================
// STAGE3D — the true 2.5D depth engine.
// -----------------------------------------------------------------------------
// PORTED VERBATIM from the sibling engine, deliberately. This module contains no
// Alaska and no Texas: it is a camera, a projection and a light model, and the
// sibling paid for every constant in it across dozens of shipped films. Rewriting
// it to look original would be throwing away the only part of the port that is
// already correct.
//
// The look it replaced was flat vector art with a lighting pass, where parallax
// was faked by drifting each background layer at a hand-tuned rate. Judges kept
// reading big fills and maps as "clip-art / slide". This is a REAL shared virtual
// camera with genuine Z separation, using the browser's own 3D projection
// (Remotion renders through Chrome, so CSS 3D transforms are real):
//
